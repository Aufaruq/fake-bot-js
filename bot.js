...
const botSay = (data) => {
  return [
    "Perkenalkan nama saya Aufabot. siapa nama kamu?",
...
function finishing() {
  pertanyaan.innerHTML = `Thank u ya ${usersData[0]} udah main ke Aufabot 😉, kali-kali kita main ${usersData[2]} bareng ya!`
